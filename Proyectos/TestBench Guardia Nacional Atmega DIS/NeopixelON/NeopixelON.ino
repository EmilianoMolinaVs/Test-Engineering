// Sketch prueba de encendido neopixel
...
Adafruit_NeoPixel pixels(1, NEOPIXEL, NEO_GRB + NEO_KHZ800);  // Objeto NeoPixel
...
void loop() {
  ...
  Serial.println("Secuencia Buzzer"); 
  melodyRun(); 
}
